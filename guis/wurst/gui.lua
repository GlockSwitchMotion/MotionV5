...
local getcustomassets = {
	['motionvape/assets/wurst/triangle.png'] = 'rbxasset://wurst/triangle.png'
}
...
local function downloadFile(path, func)
	if not isfile(path) then
		local suc, res = pcall(function() return game:HttpGet('https://raw.githubusercontent.com/YourGitHub/MotionV4/'..readfile('motionvape/profiles/commit.txt')..'/'..select(1, path:gsub('motionvape/', '')), true) end)
...
function mainapi:CreateCategory(categorysettings)
	...
	function categoryapi:CreateModule(modulesettings)
		...
		triangle.Image = getcustomasset('motionvape/assets/wurst/triangle.png')
